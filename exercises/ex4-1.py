...
import datetime, optparse, socket, errno
...
Run it like this:
  ...
  python ex4-1.py port1 port2 port3 ...

If you are in the base directory of the twisted-intro package,
you could run it like this:

  python twisted-client-1/ex4-1.py 10001 10002 10003
...
class PoetrySocket(object):
    ...
    def __init__(self, task_num, address):
        ...
        # use socket.connect_ex() instead of socket.connect() - returns an error indicator instead of raising an exception for errors
        # useful to support asynchronous connects 
        ...
        if (self.sock.connect_ex(address) == 0): 
            ...
            print("Could not connect to task %d" % task_num)
    ...
    def doRead(self):
        ...
        if not bytes:
            ...
            print  msg % (self.task_num, len(self.poem), self.format_addr())
